            ...
            (gt = (function () {
                function a(t, e) {
                    (this._isTransitioning = !1),
                        (this._element = t),
                        (this._config = this._getConfig(e)),
                        (this._triggerArray = tt.makeArray(tt('[data-toggle=""][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]')));
    ...
    var t,
        ...
        m = function (e) {
            ...
            for (var t, n = String(e), o = n.length, r = -1, a = "", i = n.charCodeAt(0); ++r < o; ) {
                ...
                a +=
                    (t >= 1 && 31 >= t) || 127 == t || (0 === r && t >= 48 && 57 >= t) || (1 === r && t >= 48 && 57 >= t && 45 === i)
                        ? "\\" + t.toString(16) + " "
                        : t >= 128 || 45 === t || 95 === t || (t >= 48 && 57 >= t) || (t >= 65 && 90 >= t) || (t >= 97 && 122 >= t)
                        ? n.charAt(r)
                        : "\\" + n.charAt(r);
            }
            return "#" + a;
        ...
        g = function (e, t) {
            ...
            return (
                ...
                "easeInOutCubic" === e && (n = 0.5 > t ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1),
                ...
                "easeInOutQuint" === e && (n = 0.5 > t ? 16 * t * t * t * t * t : 1 + 16 * --t * t * t * t * t),
                n || t
            );
        },
        p = function (e, t, n) {
